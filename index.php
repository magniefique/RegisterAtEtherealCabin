...
<body>
    <section id="alert" onclick="this.classList.remove('active');">
        <h1>You cannot pass!</h1>
        <p>Invalid username/password inputted.</p>
        <p>Click anywhere in this tab to continue...</p>
    </section>
    <section id="landing_page">
        ...
        <div class="landing_title">
            ...
            <form id="login" action="" method="post">
                <div class="login">
                    <input type="text" id="loginuser" name="loginuser" placeholder="Username" pattern="[A-Za-z0-9]+" required>
                </div>
                <div class="login">
                    <input type="password" id="loginpass" name="loginpass" placeholder="Password" pattern=".{4,}" oninput="checkPass()" required>
                </div>
                ...
                <div id="acc_dets">
                    ...
                    <div class="input_field">
                        <div class="q_cont">
                            ...
                            <input type="text" id="username" name="username" placeholder="iudex12 *" pattern="[A-Za-z0-9]+" oninput="checkUsername()" required>
                            <p class="account" id="user_confirm">Consists of only letters and numbers.</p>
                        </div>
    
                        <div class="q_cont">
                            <label for="pass">Password *</label>
                            <input type="password" id="pass" name="pass" placeholder="Enter Password *" pattern=".{4,}" oninput="checkPass()" required>
                            <p class="account" id="pass_check">Must consist of 4 or more characters.</p>
                        </div>
                ...
                <div id="pers_info">
                    ...
                    <div class="input_field">
                        ...
                        <div class="q_cont">
                            ...
                            <input type="tel" id="cnum" name="cnum" pattern="[0-9]{11}" placeholder="0912XXXXXXX " minlength="11" maxlength="11" step="2.2" required>
                        </div>
                    </div>
                </div>
                ...
                <div id="address">
                    ...
                    <div class="input_field">
                        ...
                        <div class="q_cont">
                            ...
                            <input type="tel" id="pcode" name="pcode" pattern="[0-9]{4}" placeholder="1400" maxlength="4" minlength="4" required>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="input_field" id="final_field">
                        <div class="q_cont">
                            ...
                            <select id="membertyper" name="membertyper" required>
                                <option value="default" disabled selected>Select Membership Type</option>
                        ...
                        <div class="q_cont">
                            ...
                            <select id="memberdur" name="memberdur" required>
                                <option value="default" disabled selected>Select Membership Duration</option>
                        ...
                        <div class="q_cont">
                            ...
                            <input type="text" id="ref" name="ref" pattern="[A-Z,0-9]{6}" placeholder="HT43DA" maxlength="6">
                        </div>
                        ...
                        <div class="l_cont">
                            ...
                            <div class="file_custom">
                                ...
                                <input type="file" id="memberfile" name="memberfile" accept="video/*" onchange="changeText();">
                            </div>
                        </div>
                        <div class="l_cont">
                            <div>
                                <input type="checkbox" id="verif1" name="verif1" value="verified" required>
                                <label for="verif1" style="font-weight: 200;">All the required information I have entered is correct and complete.</label>
                            </div>
                            <div style="margin-bottom: 80px;">
                                <input type="checkbox" id="verif2" name="verif2" value="verified" required>
